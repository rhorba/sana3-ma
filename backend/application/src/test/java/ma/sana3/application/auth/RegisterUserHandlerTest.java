...
class RegisterUserHandlerTest {
    ...
    void registersNewUserAndIssuesTokens() {
        RegisterUserCommand command = new RegisterUserCommand("New@Example.com", "password123", Role.BUYER);
    ...
    void rejectsDuplicateEmail() {
        RegisterUserCommand command = new RegisterUserCommand("dup@example.com", "password123", Role.BUYER);
